...
fn idle_chunks_are_discarded_without_reaching_the_recording() {
    let mut processor = CaptureProcessor::new(16_000, None, None, None, None, None, Instant::now());
...
fn shutdown_is_processed_without_audio_samples() {
    ...
    let worker = thread::spawn(move || {
        run_consumer(
            CaptureProcessor::new(48_000, None, None, None, None, None, Instant::now()),
            consumer,
            cmd_rx,
...
fn missing_callback_at_stop_marks_stream_for_rebuild_and_returns_samples() {
    ...
    let worker = thread::spawn(move || {
        run_consumer(
            CaptureProcessor::new(16_000, None, None, None, None, None, Instant::now()),
            consumer,
            cmd_rx,
            worker_transport,
            stream_error,
